...
const links = {
  ...
  Developers: ["Documentation", "API Reference", "SDKs", "Examples", "Community"],
...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/[0.04] pt-16 pb-10 px-4 overflow-hidden">
      <div className="pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-indigo-500/[0.03] blur-[80px] rounded-full" aria-hidden />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-white/30 leading-relaxed max-w-[180px] mb-5">
              The AI platform built for teams that move fast.
            </p>
            <div className="flex items-center gap-2.5">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-8 h-8 rounded-lg glass border border-white/[0.06] hover:border-white/[0.14]
                             flex items-center justify-center text-white/28 hover:text-white/65
          ...
          {Object.entries(links).map(([section, items]) => (
            <div key={section}>
              <h4 className="text-xs uppercase tracking-[0.12em] text-white/25 font-semibold mb-4">
                {section}
              </h4>
